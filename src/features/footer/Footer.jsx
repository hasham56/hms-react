    ...
    return (
        <Grid className='footer' container>
            <Grid.Row textAlign='center' className='footer-address-section'>
                <Grid.Column mobile={16} tablet={5} computer={5} className='columns vertical-line'>
                    <Grid>
                        <Grid.Column computer={5} tablet={16} mobile={6} textAlign='right' className='icons'>
                            <Icon className='footer-icons address-icons' name='map marker alternate' circular size='large' />
                        </Grid.Column>
                        <Grid.Column className='content' computer={11} tablet={16} mobile={10} textAlign='left'>
                            <p className='heading'>Our Address</p>
                            <p className='value'>Blank Slate, LHR 54000</p>
                        </Grid.Column>
                    </Grid>
                </Grid.Column>
                <Grid.Column mobile={16} tablet={6} computer={6} className='columns vertical-line'>
                    <Grid>
                        <Grid.Column computer={6} tablet={16} mobile={6} textAlign='right' className='icons'>
                            <Icon className='footer-icons address-icons' name='phone' circular size='large' />
                        </Grid.Column>
                        <Grid.Column className='content' computer={10} tablet={16} mobile={10} textAlign='left'>
            ...
            <Grid.Row>
                <Grid.Column className='footer-mid-section footer-tab footer-mobile' computer={4} tablet={8} mobile={16}>
                    <Image className='footer-logo' src={'/assets/logo.png'} size='small' />
                    <p className='footer-text'>Lorem ipsum dolor sit amet, consect etur adipisicing elit, sed diam nonu mmy nibh euis</p>
                ...
                <Grid.Column className='footer-tab footer-mobile' computer={4} tablet={8} mobile={16}>
