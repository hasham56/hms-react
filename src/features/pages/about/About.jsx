  ...
  return (
    <div className="about-page">
                ...
                <Grid>
                  <Grid.Column computer={10} className="about-text">
                    <p className="main-text">
                      DocFind is an Online Appointment system which directs you
                      to the best doctors in town.
                    </p>
                  </Grid.Column>
                  <Grid.Column computer={6} className="about-button">
                    <Button
                      className="btn-secondary appointment-btn"
                ...
                <Grid>
                  <Grid.Column width={7}>
                    <div className="step-images">
                      <Image
                        className="icon"
                        src="/assets/about/professional.svg"
                      />
                    </div>
                  </Grid.Column>
                  <Grid.Column width={9}>
                    <p className="primary-text step-heading">
                      Search Best Online Professionals
                    </p>
                    <p className="main-text">
                      List of doctors available with ratings and feedback of
                      other patients.
                    </p>
                  </Grid.Column>
                </Grid>
                ...
                <Grid>
                  <Grid.Column width={7}>
                    <div className="step-images">
                      <Image
                        className="icon"
                        src="/assets/about/appointment.svg"
                      />
                    </div>
                  </Grid.Column>
                  <Grid.Column width={9}>
                    ...
                    <p className="main-text">
                      Make appointment immediately with the doctor of your
                      choice.
                    </p>
                  </Grid.Column>
                </Grid>
              ...
              <Grid.Column>
                <Grid>
                  ...
                  <Grid.Column width={9}>
                    ...
                    <p className="main-text">
                      Give your honest feedback according to your experience.
                    </p>
                  </Grid.Column>
                </Grid>
              </Grid.Column>
      ...
      <div
        ...
        style={{ backgroundImage: 'url(/assets/about/whyUs.png)' }}
      >
        <Container className="why-us-container">
          <Grid className="why-us-content" columns={2}>
            <Grid.Column>
              <p className="basic-text heading">
                Why Choose
                <br />
                Docfind Clinic?
              </p>
              <p className="basic-text description">
                DocFind is an Online Appointment system which directs you to the
                best doctors in town. It is user friendly.
              </p>
              <Grid>
                <Grid.Column computer={4}>
                  <Image
                    className="why-us-icons"
                    src={'/assets/about/stethoscope.svg'}
                  />
                </Grid.Column>
                <Grid.Column computer={12}>
                  <p className="basic-text icon-heading">
                    Quality Control System
                  </p>
                  <p className="basic-text icon-description">
                    Have the best controling system in order to give the best
                    experience with us.
                  </p>
                </Grid.Column>
              </Grid>
              <Grid>
                ...
                <Grid.Column computer={12}>
                  ...
                  <p className="basic-text icon-description">
                    List of doctors includes highly professional doctors.
                  </p>
                </Grid.Column>
              </Grid>
            </Grid.Column>
            <Grid.Column>
              <Image
                ...
                src={'/assets/about/operationRoom.png'}
              />
              <Image
                className="doctors-image"
                src={'/assets/about/doctors.png'}
              />
            </Grid.Column>
          </Grid>
          <div className="counter-section">
            <Image
              ...
              src="/assets/about/leftCounterBG.png"
            />
            <Image
              className="right-bg-image"
              src="/assets/about/rightCounterBG.png"
            />
                ...
                <VisibilitySensor partialVisibility offset={{ bottom: 30 }}>
                  {({ isVisible }) => (
                    <div style={{ height: 40, marginBottom: '1.9em' }}>
                      {isVisible ? (
                        <CountUp start={0} end={320} delay={0} duration={2}>
                          {({ countUpRef }) => (
                            <div>
                              <span
                                className="basic-text counter-value"
                                ref={countUpRef}
                              />
                              <span className="basic-text counter-value">
                                +
                              </span>
                            </div>
                          )}
                        ...
                        <span className="basic-text counter-value">0</span>
                      )}
                    </div>
                  )}
                </VisibilitySensor>
              ...
              <Grid.Column className="counter-blocks">
                <VisibilitySensor partialVisibility offset={{ bottom: 30 }}>
                  {({ isVisible }) => (
                    <div style={{ height: 40, marginBottom: '1.9em' }}>
                      {isVisible ? (
                        <CountUp start={0} end={350} delay={0} duration={2}>
                          {({ countUpRef }) => (
                            <div>
                              <span
                                className="basic-text counter-value"
              ...
              <Grid.Column className="counter-blocks">
                <VisibilitySensor partialVisibility offset={{ bottom: 30 }}>
                  {({ isVisible }) => (
                    <div style={{ height: 40, marginBottom: '1.9em' }}>
                      {isVisible ? (
                        <CountUp start={0} end={120} delay={0} duration={2}>
                          {({ countUpRef }) => (
                            <div>
                              <span
                                className="basic-text counter-value"
              ...
              <Grid.Column className="counter-blocks">
                <VisibilitySensor partialVisibility offset={{ bottom: 30 }}>
                  {({ isVisible }) => (
                    <div style={{ height: 40, marginBottom: '1.9em' }}>
                      {isVisible ? (
                        <CountUp start={0} end={80} delay={0} duration={2}>
                          {({ countUpRef }) => (
                            <div>
                              <span
                                className="basic-text counter-value"
