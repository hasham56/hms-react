    ...
    return (
        <Grid>
            <Grid.Row className='doctor' style={{height: '200px'}}>
                <Grid.Column className='image-holder' style={{height: '200px'}} computer={4}>
                    <ContentLoader
                        speed={2}
                        width={'100%'}
                        height={'200px'}
                ...
                <Grid.Column className='portion division' style={{height: '200px'}} computer={7}>
                    <ContentLoader
                        speed={2}
                        width={'100%'}
                        height={'200px'}
                ...
                <Grid.Column className='portion review' style={{height: '200px'}} computer={5}>
                    <ContentLoader
                        speed={2}
                        width={'100%'}
                        height={'200px'}
                    ...
                    <div className='stars'>
                        ...
                        <Icon className='star' name='star' />
                        <Icon className='star' name='star' />
                        <p className='main-text' style={{fontSize: '9pt'}}>&emsp;(...)</p>
                    </div>
                </Grid.Column>
            </Grid.Row>
            <Grid.Row className='doctor' style={{height: '200px'}}>
