...
export const Contact = () => {
  ...
  return (
    <div className="contact">
          ...
          <Grid columns={3}>
            <Grid.Column>
              <Grid className="block">
                <Grid.Column className="icon-holder" computer={4}>
                  <Image
                    className="icon"
                    src="/assets/contact/pointerIcon.svg"
                  />
                </Grid.Column>
                <Grid.Column computer={12}>
                  <p className="secondary-text heading">Our Address</p>
                  <p className="main-text">
                    Blankslate, New Muslim Town, Lahore
                  </p>
                </Grid.Column>
              </Grid>
            </Grid.Column>
            ...
            <Grid.Column>
              <Grid className="block">
                ...
                <Grid.Column computer={12}>
                  <p className="secondary-text heading">Our Address</p>
                  <p className="main-text emails">
                    Email: name@blankslate.pk
                    <br />
                    Inquiries: info@blankslate.pk
                  </p>
                </Grid.Column>
              </Grid>
            </Grid.Column>
          ...
          <Formik
            ...
            onSubmit={async (values, { setSubmitting, resetForm }) => {
              try {
                ...
                else showError('Message sending failed!')
              } finally {
                setSubmitting(false)
              }
            }}
      ...
      <div className="map">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d850.4173079375109!2d74.33936699653415!3d31.50577443063355!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3919044337da7039%3A0x4aef7cf6ff38111c!2sInstitute%20of%20Management%20Sciences%2C%20Lahore!5e0!3m2!1sen!2s!4v1661159417893!5m2!1sen!2s"
          title="map"
          style={{ border: 0 }}
          width="100%"
          height="450"
