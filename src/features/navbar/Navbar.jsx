  ...
  return (
    <div className="navbar" fixed="top">
      <div className="nav-top">
        <Label
          className="nav-label mobile-view"
          basic
          content="2072 Pinnickicick Street, WA 98370"
        ...
        <Dropdown
          text={
            authenticated
              ? currentUserProfile
                ? 'Hi! ' + currentUserProfile.displayName
                : 'Loading...'
              : 'Account'
          }
          icon={
          ...
          disabled={authenticated ? (currentUserProfile ? false : true) : false}
          button
        ...
        >
          {authenticated ? (
            ...
            <Dropdown.Menu className="dropdown">
              <Dropdown.Item className="item" as={NavLink} to="/login">
                <Icon name="sign in" />
                &nbsp;&nbsp;Login
              </Dropdown.Item>
              <Dropdown.Item className="item" as={NavLink} to="/signup">
                <Icon name="signup" />
                &nbsp;&nbsp;Sign Up
              </Dropdown.Item>
            </Dropdown.Menu>
